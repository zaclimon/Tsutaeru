...
public class TsutaeruTvInputSetupFragment extends ChannelSetupFragment {
    ...
    /**
     * Initially syncs the EPG data for a user. Basing itself from {@link TsutaeruJobService} it also
     * sets up a periodic sync.
     */
    private void startEpgSync() {
        EpgSyncJobService.cancelAllSyncRequests(getActivity());
        EpgSyncJobService.requestImmediateSync(getActivity(), mInputId, new ComponentName(getActivity(), TsutaeruJobService.class));
        EpgSyncJobService.setUpPeriodicSync(getActivity(), mInputId, new ComponentName(getActivity(), TsutaeruJobService.class));
    }
}
