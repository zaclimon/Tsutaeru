...
public class TsutaeruTvEpgReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (jobInfos.isEmpty()) {
            ...
            EpgSyncJobService.setUpPeriodicSync(context, inputId, new ComponentName(context, TsutaeruJobService.class));
            return;
        }
