...
/**
 * {@link GuidedStepFragment} which lists several regions in which the user can select for his/her
 * Live TV experience.
 *
 * @author zaclimon
...
public class ChannelRegionGuidedFragment extends GuidedStepSupportFragment {
    ...
    public void onGuidedActionClicked(GuidedAction guidedAction) {
        if (guidedAction.getId() == GuidedAction.ACTION_ID_OK) {
            ...
            SharedPreferences sharedPrerefences = getActivity().getSharedPreferences(Constants.ACE_TV_PREFERENCES, Context.MODE_PRIVATE);
