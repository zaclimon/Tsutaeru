...
public class AceTvInputService extends BaseTvInputService {
     ...
     * <p>
     * It also implements an {@link com.google.android.exoplayer2.Player.EventListener} in which
     * it can adapt better to callbacks from a {@link AcePlayer}
     */
    private class AceSession extends Session implements Player.EventListener {
